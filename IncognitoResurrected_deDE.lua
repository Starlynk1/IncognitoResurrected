...
L["guildinfo"] =
    "Gildenchat-Nachrichten werden aus dem Chatfenster erzeugt, nicht aus dem Gildenfenster."
...
L["battleground_desc"] =
    "Deinen Namen bei Chatnachrichten in Schlachtfeldern anzeigen (/i)."

L["arena"] = "Arena"
L["arena_desc"] = "Deinen Namen bei Chatnachrichten in Arenen anzeigen (/i)."

L["world_chat"] = "Weltchat"
L["world_chat_desc"] =
    "Deinen Namen zu Nachrichten im Weltchat hinzufügen, z. B. Allgemein, Handel, Lokale Verteidigung und Dienstleistungen.\n-- Dies ist eine Alles-oder-nichts-Option, du kannst nicht auswählen, welche Weltkanäle aktiviert/deaktiviert werden."
...
L["channel"] = "Kanal"
L["channel_desc"] =
    "Fügen Sie Chatnachrichten in diesem benutzerdefinierten Kanal einen Namen hinzu. Verwenden Sie Kommas, um die Kanalnamen zu trennen."

L["community"] = "Gemeinschaft"
L["community_desc"] =
    "Fügen Sie Chat-Nachrichten in den Community-Kanälen einen Namen hinzu."
...
L["channel_info_text"] =
    "Say Channel ist keine Option. Dies ist eine Einschränkung innerhalb der Blizzard-API."
L["community_info_text"] =
    "Derzeit ist dies eine Alles-oder-Nichts-Option für Community-Kanäle."

L["colorizePrefix"] = "Namenspräfix in Klassenfarbe färben"
L["colorizePrefix_desc"] =
    "Färbt jedes führende eingeklammerte Namenspräfix ((), [], {}, <>) in der Klassenfarbe des Absenders auf deinem Client."

L["partialMatchMode"] = "Teilweiser Abgleich"
L["partialMatchMode_desc"] =
    "Blendet das Präfix aus, wenn der Charaktername gemäß der ausgewählten Regel mit dem konfigurierten Namen übereinstimmt (Groß-/Kleinschreibung ignoriert). Erfordert, dass 'Name nicht anzeigen, wenn er mit dem Charakternamen übereinstimmt' aktiviert ist."

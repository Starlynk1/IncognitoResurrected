...
L["channel_info_text"] = "Мировые каналы не являются допустимыми опциями.\nЭто ограничение API Blizzard."
...
L["partialMatchMode_desc"] = "Скрывать префикс, когда имя персонажа соответствует настроенному имени по выбранному правилу (без учёта регистра). Требует включения опции 'Скрыть имя, если оно совпадает с именем персонажа'."
